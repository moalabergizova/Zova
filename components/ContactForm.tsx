  ...
  return (
    <section id="contact" className="py-16 px-8" style={{ backgroundColor: '#1E1E1E', position: 'relative', overflow: 'hidden' }}>
      ...
      <div aria-hidden="true" style={{
        position: 'absolute', top: 0, left: 0, width: '520px', height: '420px',
      ...
      <div aria-hidden="true" style={{
        position: 'absolute', bottom: 0, right: 0, width: '520px', height: '420px',
      ...
      <div className="max-w-6xl mx-auto" style={{ position: 'relative', zIndex: 1 }}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-12">
          <div>
            <h2 style={{
              fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif",
              fontWeight: 200, fontSize: 'clamp(28px, 4vw, 42px)', color: '#F5F5F3',
            ...
            <p style={{
              fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif",
              fontWeight: 400, fontSize: '14px', color: 'rgba(245,245,243,0.55)', lineHeight: 1.8,
            }}>
              {t.subline}
            </p>
          </div>
        ...
        {status === 'success' ? (
          <div className="py-20">
            ...
            <p style={{
              fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif",
              fontWeight: 200, fontSize: 'clamp(28px, 4vw, 48px)', color: '#F5F5F3',
          ...
          <form onSubmit={handleSubmit} noValidate>
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3">
                        ...
                        <span style={{
                          fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif",
                          fontWeight: checked ? 400 : 300, fontSize: '13px', color: '#F5F5F3',
            ...
            <button
              ...
              style={{
                ...
                color: '#0E0E0E',
                fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif",
                fontWeight: 300, fontSize: '11px', letterSpacing: '2.5px', textTransform: 'uppercase',
                padding: '16px 48px', border: 'none',
                cursor: status === 'loading' ? 'not-allowed' : 'pointer',
                minWidth: '200px', width: '100%', maxWidth: '320px',
              }}
            >
